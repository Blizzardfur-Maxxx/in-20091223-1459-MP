...
import net.minecraft.game.level.LevelIO;
...
public final class Minecraft implements Runnable {
	...
	public final void run() {
		...
		try {
			...
			if(this.serverIp != null && this.session != null) {
				this.networkClient = new Client(this, this.serverIp, this.port, this.session.username, this.session.mpPass);
			} else {
				boolean z9 = false;
				point10 = null;
				...
				if(this.isGamePaused) {
					...
					try {
						...
						if(entityRenderer39.mc.theWorld != null) {
							...
							entityRenderer39.mc.ingameGUI.renderGameOverlay(f41, true, displayWidth, displayHeight);
						} else {
	...
	private void clickMouse(int id) {
		if(id != 0 || this.leftClickCounter <= 0) {
			...
			int i2;
			if(id == 1 && (i2 = this.thePlayer.inventory.getCurrentItem()) > 0 && this.playerController.removeResource(this.thePlayer, i2)) {
				tileRenderer6 = this.entityRenderer.itemRenderer;
				...
				if(this.objectMouseOver.typeOfHit == 1) {
					...
					if(id == 0) {
						...
						if((id = this.thePlayer.inventory.getCurrentItem()) <= 0) {
							return;
						}
	...
	private void clickMouseold(int i1) {
				...
				if(this.objectMouseOver.typeOfHit == 1) {
					...
					if(i1 == 0) {
						...
						if((block9 = Block.blocksList[this.theWorld.getBlockId(i2, i3, i4)]) == null || block9 == Block.waterMoving || block9 == Block.waterStill || block9 == Block.lavaMoving || block9 == Block.lavaStill) {
							...
							int i8;
							if((i8 = this.thePlayer.inventory.getCurrentItem()) <= 0) {
								return;
							}

							Block tile9;
							AxisAlignedBB aABB10;
							if(((tile9 = Block.blocksList[this.theWorld.getBlockId(i2, i3, i4)]) == null || tile9 == Block.waterStill || tile9 == Block.waterStill || tile9 == Block.lavaStill || tile9 == Block.lavaStill) && ((aABB10 = Block.blocksList[i8].getCollisionBoundingBoxFromPool(i2, i3, i4)) == null || (this.thePlayer.boundingBox.intersects(aABB10) ? false : this.theWorld.checkIfAABBIsClear(aABB10)))) {
								if(!this.playerController.removeResource(i8)) {
									return;
								}

								if(this.isOnlineClient()) {
									this.networkClient.sendTileUpdated(i2, i3, i4, i1, i8);
								}
							this.theWorld.netSetTile(i2, i3, i4, i1);
							itemRenderer5 = this.entityRenderer.itemRenderer;
	...
	private void runTick() {
	    ...
	    if (this.networkClient != null && !(this.currentScreen instanceof GuiErrorScreen)) {
	        if (!this.networkClient.isConnected()) {
							...
							while(socketConnection21.readBuffer.position() > 0 && i41++ != 100) {
								...
								if(socketConnection21.client.processData) {
									if(packet6 == Packet.LOGIN) {
										...
										level30.generate(s59, s62, s27, b56);
											...
											if(packet6 == Packet.PLAYER_TELEPORT) {
												...
												if(packet6 == Packet.PLAYER_MOVE_AND_ROTATE) {
													...
													if(b5 >= 0 && (networkPlayer34 = (NetworkPlayer)client43.players.remove(b5)) != null) {
														...
														//client43.minecraft.theWorld.removeEntity(networkPlayer34);
													}
													...
													b5 = b10001;
													if(b5 < 0) {
														client43.minecraft.ingameGUI.addMessage("&e" + string33);
													} else {
														client43.players.get(b5);
														client43.minecraft.ingameGUI.addMessage(string33);
													}
				...
				EntityPlayer player31 = this.thePlayer;
						...
						do {
							...
							if(this.currentScreen == null) {
								...
								if(Keyboard.getEventKey() == Keyboard.KEY_X) {
									this.thePlayer.flying = !this.thePlayer.flying;
								}
